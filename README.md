...
- System view: AI-generated planet sprites (rocky / ocean types), animated ship visible near the star
- Player ship sprite (freighter class) rendered with shader-based background removal
...
- Nebula background (pack-02) integrated into Galaxy Map and System View
- AI-generated planet sprites from 2×2 concept sheets, clipped to circle via GLSL shader
- Player ship sprite (ship-01) visible in System View with dark-removal shader
- Asset brief created at `assets/FOR_ARAS.md` for Aras: specs transparent PNGs, individual files, filenames, resolutions
- **Known limitation:** Shader workaround for planet circles not perfect — will be replaced once Aras delivers individual transparent PNGs
- **Scope decision:** Sprites now generated by Aras (GPT Image 2), not Midjourney
